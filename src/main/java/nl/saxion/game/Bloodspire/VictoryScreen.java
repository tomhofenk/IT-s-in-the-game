...
public class VictoryScreen extends ScalableGameScreen {
    ...
    private void drawDoodScreen() {
        ...
        GameApp.drawTextCentered("Basic", "VICTORY",getWorldWidth()/2,getWorldHeight()-200, Color.GOLD);
        GameApp.drawTextCentered("PixelSmall", "Defeated  The   Almighty   Stout   Woutje", getWorldWidth()/2, getWorldHeight()-450, Color.WHITE);
